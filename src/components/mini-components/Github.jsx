...
const Github = () => {
  return (
    <div className="hidden md:block absolute left-10 2xl:left-[12rem] top-[14rem] w-1/5 2xl:w-1/6 border-solid border-black border-4 shadow-custom rounded-sm bg-vlGreen">
