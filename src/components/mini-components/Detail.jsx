...
const Detail = () => {
  return (
    <div className="absolute md:right-6 2xl:right-[12rem] top-[29rem] 2xl:top-[11rem] md:top-[10rem] w-3/5 md:w-1/5 border-solid border-4 border-black shadow-custom rounded-sm bg-vlGreen">
